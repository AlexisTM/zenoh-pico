...
#if Z_USE_ATOMIC_FALLBACK /* Useful for CXX platforms that don't provide std::atomic */
typedef enum
  {
...
#endif
#define _z_atomic_load_explicit __atomic_load_n
#define _z_atomic_compare_exchange_strong(a,b,c,d,e) __atomic_compare_exchange_n(a,b,c,false,d,e)
#define _z_atomic_compare_exchange_weak_explicit(a,b,c,d,e) __atomic_compare_exchange_n(a,b,c,true,d,e)
#define _z_memory_order_acquire memory_order_acquire
#define _z_memory_order_release memory_order_release
#define _z_memory_order_relaxed memory_order_relaxed
#else
...
#endif  // ZENOH_CXX_ATOMIC_FALLBACK
#endif  // __cplusplus
